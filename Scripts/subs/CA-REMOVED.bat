...
certmgr.exe -del      /all .\file\CA-ECCP521.crt -s -r currentUser AuthRoot
certmgr.exe -del      /all .\file\CA-RSA8192.crt -s -r currentUser AuthRoot
certmgr.exe -del      /all .\file\CA-RSA4096.crt -s -r currentUser AuthRoot
cls
...
certmgr.exe -del      /all .\sign\CA-ECCP521.crt -s -r currentUser AuthRoot
certmgr.exe -del      /all .\sign\CA-RSA8192.crt -s -r currentUser AuthRoot
certmgr.exe -del      /all .\sign\CA-RSA4096.crt -s -r currentUser AuthRoot
cls
...
cls
certmgr.exe -crl -del /all .\cert\mids\CA-RSA3072.crl -s -r localMachine AuthRoot
certmgr.exe -del      /all .\cert\mids\CA-RSA3072.crt -s -r localMachine AuthRoot
cls
